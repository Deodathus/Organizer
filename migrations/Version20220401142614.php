...
final class Version20220401142614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipes_ingredients (
        ...
        $this->addSql('CREATE TABLE recipe_result (
            id INT AUTO_INCREMENT NOT NULL, 
            item_id INT DEFAULT NULL, 
        ...
        $this->addSql('ALTER TABLE ingredient ADD CONSTRAINT FK_6BAF7870126F525E FOREIGN KEY (item_id) REFERENCES items (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE recipe_result ADD CONSTRAINT FK_9E74DF32126F525E FOREIGN KEY (item_id) REFERENCES items (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE recipe_result ADD CONSTRAINT FK_9E74DF3259D8A214 FOREIGN KEY (recipe_id) REFERENCES recipe (id) ON DELETE CASCADE');
    }
